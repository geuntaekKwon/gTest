...
<div id="wrapper">
	...
	<table border="1">
		<tr>
			<th>아이디</th>
			<td>
				<input type="text" id="custid" name="custid" value="${customer.custid}" readonly="readonly" />
			</td>	
		</tr>
		<tr>
			<th>비밀번호</th>
		...
		<tr>
			<th>회원구분</th>
			<td>
 				<input type="radio" id="division" name="division" value="personal" ${customer.division=='personal' ? 'checked="checked"' : ''} />개인회원 &nbsp;
				<input type="radio" id="division" name="division" value="company"  ${customer.division=='company' ? 'checked="checked"' : ''} />기업회원
			</td>	
		</tr>
		<tr>
			<th>식별번호</th>
